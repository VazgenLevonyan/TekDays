...
<div class="nav" role="navigation">
    <ul>
        ...
        <li><g:link class="create" controller="TekTask" action="create">Create
Task</g:link></li>
        <li><g:link class="create" controller="TekSponsorship" action="create">Add
Sponsor</g:link></li>
        <li><g:link class="list" controller="TekSponsor" action="index">All
Sponsors</g:link></li>
    </ul>
</div>
